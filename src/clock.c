...
void initSystemClockTo16Mhz(void)
{
    // Configure HW to work with 16 MHz XTAL, PLL enabled, sysdivider of 25, creating system clock of 16 MHz
    SYSCTL_RCC_R = SYSCTL_RCC_XTAL_16MHZ    // 16 MHz crystal
                 | SYSCTL_RCC_OSCSRC_MAIN   // Main oscillator source
                 | SYSCTL_RCC_USESYSDIV     // Use system divider
                 | (24 << SYSCTL_RCC_SYSDIV_S); // Divide by 25 (24 + 1)
}
